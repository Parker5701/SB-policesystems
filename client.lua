...
RegisterCommand('sv', function(source, args, user)
	if PlayerData.job.name == 'police' then
        ...
        local newCoords = {x = 442.41, y = -1019.7, z = 28.65}
        local dist = Vdist2(coords.x, coords.y, coords.z, newCoords.x, newCoords.y, newCoords.z)
        if dist <= 1000.0 then
			...
			exports['mythic_notify']:SendAlert('error', 'You are not at Mission Row')
		end
